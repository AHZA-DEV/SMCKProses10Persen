...
<head>
    ...
    <title>Admin Dashboard - SMCK</title>
    <!-- Bootstrap CSS -->
...
<body class="dashboard-page">
    ...
    <script>
        ...
        // Chart untuk departemen
        const ctx2 = document.getElementById('departemenChart').getContext('2d');
        new Chart(ctx2, {
            type: 'doughnut',
            data: {
                labels: ['IT', 'HRD', 'Keuangan', 'Marketing', 'Operasional'],
                datasets: [{
                    data: [30, 25, 20, 15, 10],
                    backgroundColor: [
                        '#FF6384',
